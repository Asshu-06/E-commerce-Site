export default function InstagramButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-24 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full shadow-lg active:scale-95 transition-all duration-200 hover:scale-110"
      style={{
